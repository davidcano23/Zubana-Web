<fieldset>
    ...
    <input type="text" placeholder="Ej: Rionegro, Antioquia" id="ubicacion" name="propiedad[ubicacion]" value="<?php echo trim(s($propiedad?->ubicacion ?? '')); ?>">
    ...
    <input type="text" placeholder="Ej: El Caney" id="barrio" name="propiedad[barrio]" value="<?php echo trim(s($propiedad?->barrio ?? '')); ?>">
    ...
    <input type="file" id="imagen" accept="image/*"  class="custom-file-input" name="propiedad[imagen]">
