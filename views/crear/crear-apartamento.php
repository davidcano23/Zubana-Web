<main class="contenedor crear">
    ...
    <legend>Tipo de Propiedad</legend>
        ...
        <select id="tipo-propiedad" class="select-estilizado" name="propiedad[tipo]">
            ...
            <option value="Apartaestudio" <?php echo ($propiedad?->tipo === 'Apartaestudio') ? 'selected' : ''; ?>>Apartaestudio</option>
            <option value="Apartaoficina" <?php echo ($propiedad?->tipo === 'Apartaoficina') ? 'selected' : ''; ?>>Apartaoficina</option>
        </select>

        <input type="hidden" name="propiedad[actualizacion]" value="apartamento">
    ...
    <fieldset>
        ...
        <label for="sala_comedor">Sala Comedor</label>
        <select id="sala" class="select-estilizado" name="propiedad[sala_comedor]">
            <option value="" disabled <?php echo empty($propiedad?->sala_comedor) ? 'selected' : ''; ?>>-- Selecciona una opción --</option>
            <option value="Si" <?php echo ($propiedad?->sala_comedor === 'Si') ? 'selected' : ''; ?>>Si</option>
            <option value="No" <?php echo ($propiedad?->sala_comedor === 'No') ? 'selected' : ''; ?>>No</option>
        </select>

        <label for="balcon">Balcón</label>
        <select id="balcon" class="select-estilizado" name="propiedad[balcon]">
            <option value="" disabled <?php echo empty($propiedad?->balcon) ? 'selected' : ''; ?>>-- Selecciona una opción --</option>
        ...
        <select id="tipo-unidad" class="select-estilizado" name="propiedad[tipo_unidad]">
            ...
            <option value="publica" <?php echo ($propiedad?->tipo_unidad === 'publica') ? 'selected' : ''; ?>>Pública</option>
        </select>
    </fieldset>
